<?php return array (
  ...
  'manager.setup.citationFilterParserDescription' => '<p>To find and check citations in citation databases they first have to be split into machine readable metadata: title, publisher, publication date, etc. must all be extracted from the original citation text provided by the author. Connectors to external web services can assist in this process. One or several connectors can be added by clicking on the "Add Item" button below. Some of these connectors may need to be configured; you will be prompted if this is the case.</p>
		<p class="alert alert-info">You can edit or delete an existing Connector by clicking the gear icon next to it.</p>',
  ...
  'manager.setup.citationFilterLookupDescription' => '<p>You must also enable and configure connections to external citation databases. This helps you to find errors in authors\' citations or add additional information (e.g. DOIs or PubMed IDs) required for electronic publishing or deposit.</p>
		...
		<div class="alert alert-info"><p>You can edit or delete an existing external database connection by clicking the gear icon next to it.</p>
		<p><strong>Note:</strong> In order for the citation checking process to complete in a timely manner, the <tt>citation_checking_max_processes</tt> directive in your configuration file must be set to a reasonable value. See the General Settings section in <tt>config.inc.php</tt> for more information.</p> </div>',
