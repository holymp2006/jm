<?php return array (
  ...
  'common.openJournalSystems' => 'Journal Managers',
...
<p>The system could not automatically overwrite the configuration file. To apply your configuration changes you must open <tt>config.inc.php</tt> in a suitable text editor and replace its contents with the contents of the text field below.</p>',
  ...
  'plugins.categories.auth.description' => 'Authorization Plugins allow Journal Managers to delegate user authentication tasks to other systems, such as LDAP servers.',
  ...
  'plugins.categories.generic.description' => 'Generic plugins are used to extend Journal Managers in a variety of ways that are not supported by the other plugin categories.',
  ...
  'manager.setup.preservationDescription' => 'Journal Managers supports the <a href="http://www.lockss.org/" target="_blank">LOCKSS</a> (Lots of Copies Keep Stuff Safe) system to ensure secure and permanent preservation of your journal. You have several options for including your journal in a LOCKSS network:',
...
<br />
<p class="alert alert-info">Note that if your site administrator has already registered this site with these services, your journal will be indexed automatically and you do not need to register your journal.</p>',
...
<li>Use <strong>*</strong> in a term as a wildcard to match any sequence of characters; e.g., <em>soci* morality</em> would match documents containing "sociological" or "societal"</li>
  ...
  'about.aboutOJSJournal' => 'This journal uses Journal Managers {$ojsVersion}, which is open source journal management and publishing software developed, supported, and freely distributed by the <a href="http://pkp.sfu.ca/">Public Knowledge Project</a> under the GNU General Public License.',
  'about.aboutOJSSite' => 'This site uses Journal Managers {$ojsVersion}, which is open source journal management and publishing software developed, supported, and freely distributed by the <a href="http://pkp.sfu.ca/">Public Knowledge Project</a> under the GNU General Public License.',
  'help.ojsHelp' => 'Journal Managers Help',
...
Your server currently supports mbstring: <strong>{$supportsMBString}</strong>',
  ...
  'installer.installApplication' => 'Install Journal Managers',
  'installer.upgradeApplication' => 'Upgrade Journal Managers',
