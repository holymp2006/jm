<?php return array (
  ...
  'plugins.generic.translator.longdescription' => 'This area allows the Site Administrator to build, modify and check translations of OJS. This is site-wide and should not be used to customize a single OJS journal. If you correct or create a translation, please consider submitting it to the Public Knowledge Project for distribution with future releases.',
  'plugins.generic.translator.localeDescription' => 'This page lists all components of an OJS translation and provides the translator with the opportunity to edit each. A full translation of a translation should contain complete translations of all components.',
  ...
  'plugins.generic.translator.email.description' => 'In the following fields, translate the email template\'s Title, Body, and Description. The Description is for the Journal Manager\'s reference only.',
