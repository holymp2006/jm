...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'common/breadcrumbs.tpl', 13, false),array('function', 'translate', 'common/breadcrumbs.tpl', 13, false),array('modifier', 'escape', 'common/breadcrumbs.tpl', 17, false),)), $this); ?>
	<ol class="breadcrumb">
		<li>
...
">
			<?php endif; ?><?php echo $this->_tpl_vars['pageCrumbTitleTranslated']; ?>
<?php if ($this->_tpl_vars['requiresFormRequest']): ?>
				</span>
			<?php else: ?>
				</a>
