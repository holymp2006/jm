...
<div class="block" id="sidebarProofreader">
	<span class="blockTitle"><h4 class="jm-sidebar-list-heading"><i class=" glyphicon glyphicon-refresh"></i> {translate key="user.role.proofreader"}</h4></span>
	...
	<ul style="margin-top: 8px;">
		...
		<li class="jm-sidebar-list-item"><a href="{url op="index" path="completed"}"><i class="glyphicon glyphicon-briefcase"> {translate key="common.queue.short.completed"}</a>&nbsp;<span class="badge">{if $submissionsCount[1]}{$submissionsCount[1]}{else}0{/if}</span></li>
	</ul>
</div>
