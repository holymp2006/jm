...
>>>>>>> test
							...
							<li><a tabindex="-1" href="#"><i class="fa fa-hand-o-right"></i>Get Direction</a></li>	
						</ul> 
					</li>  
...
>>>>>>> test
					...
					{else}
					<li id="login"><a class="btn btn-default btn-sm" href="{url page="login"}">{translate key="navigation.login"}</a></li>
					{if !$hideRegisterLink}
					<li id="register"><a class="btn btn-default btn-sm" href="{url page="user" op="register"}">{translate key="navigation.register"}</a></li>
					{/if}
					{/if}{* $isUserLoggedIn *}
