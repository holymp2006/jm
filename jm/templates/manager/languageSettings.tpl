 ...
 *}
 ...
 <form method="post" action="{url op="saveLanguageSettings"}">
 	...
 	<div class="form-horizontal">
 		<div class="form-group">
 			{fieldLabel name="primaryLocale" required="true" key="locale.primary" class="col-sm-2 control-label"} 
 			<div class="col-sm-10">
 ...
 <p class="alert alert-info"><span class="instruct">{translate key="manager.languages.noneAvailable"}</span></p>
 {/if}
